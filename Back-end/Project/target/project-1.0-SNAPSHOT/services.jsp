...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="service.jsp">Dịch Vụ</a></li>
    ...
    <section class="container-fluid p-0">
        <img src="./imgs/service-banner.jpg" class="w-100" alt="Dịch Vụ Thú Cưng" />
    </section>
            ...
            <div class="col-md-4 mb-4">
                <div class="card">
                    ...
                    <div class="card-body text-center">
                        ...
                        <a href="bookService.jsp?id=<%= service.getServiceID() %>" class="btn btn-success">Đặt Lịch</a>
                    </div>
                </div>
            </div>
            <% } } else { %>
