...
<html lang="vi">
    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="doctor.jsp">Dịch Vụ Thú Y</a></li>
        ...
        <section class="container py-5">
            <h2 class="text-center mb-4">Dịch Vụ Thú Y Chuyên Nghiệp</h2>
            <div class="row">
                <% List<Service> doctorServices = (List<Service>) request.getAttribute("doctorServices");
                   if (doctorServices != null) {
                       for (Service service : doctorServices) { %>
                <div class="col-md-4 mb-4">
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                            ...
                            <a href="bookAppointment.jsp?id=<%= service.getServiceID() %>" class="btn btn-success">Đặt Lịch</a>
                        </div>
                    </div>
                </div>
                <% } } else { %>
