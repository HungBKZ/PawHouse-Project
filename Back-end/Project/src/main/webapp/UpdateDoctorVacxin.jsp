        ...
        <div class="container mt-5">
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    <!-- Form cập nhật -->
                    <form action="${pageContext.request.contextPath}/UpdateDoctorVacxin" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="vaccinationDetails" class="form-control" rows="3" required>${record.vaccinationDetails}</textarea>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input 
                                ...
                                class="form-control"
                                value="${record.nextVaccinationDate}">
                        </div>
                        ...
                        <div class="text-end">
                            <a href="UpdateDoctorVacxin" class="btn btn-secondary">Hủy</a>
