...
<head>
    <meta charset="UTF-8">
    <title>Add New Pet - PawHouse</title>
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h4 class="mb-0"><i class="fas fa-plus-circle"></i> Add New Pet</h4>
                    </div>
                    <div class="card-body">
                        <form action="${pageContext.request.contextPath}/staff/pets/add" method="post" enctype="multipart/form-data">
                            <div class="row mb-3">
                                <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                <label class="form-label">Pet Image <span class="text-danger">*</span></label>
                                <input type="file" class="form-control" name="petImage" accept="image/*" required onchange="previewImage(this)">
