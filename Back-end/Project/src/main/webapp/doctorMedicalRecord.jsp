                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-sm btn-warning me-2"
                                            onclick="window.location.href = '${pageContext.request.contextPath}/UpdateMedicalRecord?action=update&recordId=${record.recordID}'">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="addRecordForm" action="${pageContext.request.contextPath}/medical-record" method="post">
