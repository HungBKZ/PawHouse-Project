...
@WebServlet(name = "SuppliesProductServlet", urlPatterns = {"/SuppliesProduct"})
public class SuppliesProductServlet extends HttpServlet {
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<ProductCategories> categories = dao.getAllCategoriesByType("Đồ Dùng");
        ...
        if (categoryParam != null && !categoryParam.isEmpty()) {
            try {
                ...
                productList = dao.getProductsByType("Đồ Dùng");
            }
        } else {
        ...
        request.setAttribute("suppliesList", productList);
