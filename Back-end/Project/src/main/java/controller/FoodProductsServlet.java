...
@WebServlet(name = "FoodProductsServlet", urlPatterns = {"/FoodProducts"})
public class FoodProductsServlet extends HttpServlet {
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<ProductCategories> categories = dao.getAllCategoriesByType("Thức Ăn");
        ...
        if (categoryParam != null && !categoryParam.isEmpty()) {
            try {
                ...
                productList = dao.getProductsByType("Thức Ăn");
            }
        } else {
        ...
        request.setAttribute("foodList", productList);
